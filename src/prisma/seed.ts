    ...
    const tripDefs = [
        {
            ...
            routeId: lagosAbuja.id,
            vehicleId: IDS.busA1,
            startLocationId: lagosAbuja.startLocationId,
            endLocationId: lagosAbuja.endLocationId,
            driverId: driver1.id,
        ...
        },
        {
            ...
            routeId: lagosAkure.id,
            startLocationId: lagosAkure.startLocationId,
            endLocationId: lagosAkure.endLocationId,
            vehicleId: IDS.minibusB1,
            driverId: driver2.id,
        ...
        },
        {
            ...
            routeId: abujaLokoja.id,
            startLocationId: abujaLokoja.startLocationId,
            endLocationId: abujaLokoja.endLocationId,
            vehicleId: IDS.shuttleC1,
            driverId: null,
